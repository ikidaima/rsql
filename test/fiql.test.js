...
test('lt method', () => {
  ...
  expect(rsql().lt('a', 1).toString()).toBe('a=lt=1');
  expect(rsql().lt('a', 0).toString()).toBe('a=lt=0');
...
test('le method', () => {
  ...
  expect(rsql().le('a', 1).toString()).toBe('a=le=1');
  expect(rsql().le('a', 0).toString()).toBe('a=le=0');
...
test('gt method', () => {
  ...
  expect(rsql().gt('a', 1).toString()).toBe('a=gt=1');
  expect(rsql().gt('a', 0).toString()).toBe('a=gt=0');
...
test('ge method', () => {
  ...
  expect(rsql().ge('a', 1).toString()).toBe('a=ge=1');
  expect(rsql().ge('a', 0).toString()).toBe('a=ge=0');
...
test('group method', () => {
  ...
  expect(rsql().group('a=1;b=2').toString()).toBe('(a=1;b=2)');
